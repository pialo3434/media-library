...
Esta opção realiza uma procura por termo (cadeia de caracteres), pedido através de `Message.requestSearchTerm()`. Como resultado, deve ser apresentada uma lista das obras encontradas
pela pesquisa, ordenadas por ordem crescente do seu identificador, utilizando o formato descrito para Mostrar obra.
